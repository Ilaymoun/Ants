...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        if insect.is_ant:
            ...
            # BEGIN Problem 13
            "*** YOUR CODE HERE ***"
            if isinstance(insect, QueenAnt) and insect.real_queen == True:
                return
            # END Problem 13

            # Special handling for container ants
            if self.ant.is_container and (self.ant.contained_ant is insect) or self.ant is insect:
                # Bodyguard was removed. Contained ant should remain in the game
                if hasattr(self.ant, 'is_container') and self.ant.is_container and self.ant is insect:
                    self.ant = self.ant.contained_ant
                # Contained ant was removed. Bodyguard should remain
                elif hasattr(self.ant, 'is_container') and self.ant.is_container \
...
class Ant(Insect):
    ...
    def can_contain(self, other):
        # if self.is_container == False and other.is_container == False:
        #     return True
        return False
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while curr_place != hive:
            #if range >= self.min_range and range <= self.max_range:
            if curr_place.bees != [] and range >= self.min_range and range <= self.max_range:
...
class BodyguardAnt(Ant):
    ...
    def can_contain(self, other):
        # BEGIN Problem 9
        "*** YOUR CODE HERE ***"
        if self.is_container == True and other.is_container == False and self.contained_ant == None:
            return True
        return False
        # END Problem 9
...
# END Problem 13
    ...
    def action(self, colony):
        ...
        if self.real_queen == False:
            ...
            while location != None:
                curr_ant = location.ant
                if curr_ant != None:
                    if curr_ant not in self.buffed_ant:
                        curr_ant.damage *= 2
                        self.buffed_ant.append(curr_ant)
                    if curr_ant.is_container and curr_ant.contained_ant != None:
                        if curr_ant.contained_ant not in self.buffed_ant:
                            curr_ant.contained_ant.damage *= 2
                            self.buffed_ant.append(curr_ant.contained_ant)
